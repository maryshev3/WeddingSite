      ...
      <div className="w-full">
        ...
        <div className="shadow-lg p-8 relative" style={{ backgroundColor: '#c4d8ed', color: '#1a1a1a' }}>
          <div className="flex flex-col items-center justify-center gap-8">
            ...
            <div className="flex items-center justify-center my-0 md:my-0">
              <p className="text-3xl font-TildaScriptRegular">А + Э = ♡︎</p>
            </div>

            <div className="text-center">
              <p className="font-CormorantInfantBold text-3xl mb-8 leading-relaxed tracking-wider">
                    ...
                    return (
                      <div key={unit} className="text-center">
                        <div className="bg-transparent flex flex-col items-center justify-center">
                          <span className="text-3xl font-semibold font-CormorantInfantBold">{value}</span>
        ...
        <div className="bg-[url('/images/background_image.webp')] bg-cover bg-center bg-no-repeat shadow-lg p-8 text-center relative min-h-[500px]">
          <div className="bg-white mx-8 md:mx-auto my-8 md:my-16 max-w-4xl p-8 rounded-2xl shadow-2xl relative z-10">
            {/* Invitation Text */}
            <div className="text-center">
              <h2 className="text-3xl sm:text-4xl font-TildaScriptRegular mb-6">Дорогой Гость!</h2>
              <p className="text-xl sm:text-2xl font-CormorantInfantLite mb-6">
              ...
              <p className="text-3xl sm:text-4xl font-CormorantInfantLite mb-6">
                ПОДТВЕРЖДЕНИЕ
              </p>
              <p className="text-xl sm:text-2xl font-CormorantInfantLite mb-12">
                Пожалуйста подтвердите свое присутствие до 20.04.2026
              </p>
              <p className="text-3xl sm:text-4xl font-TildaScriptRegular mb-6">
            ...
            {[
              ...
              <div key={index} className="flex items-start gap-4 sm:gap-16 p-4">
                <div className="flex-shrink-0 w-20 min-w-20">
                  {item.time && (
                    <span className="text-xl sm:text-2xl font-CormorantInfantBold block text-right">
                      {item.time}
                    </span>
                  )}
                </div>
                <div className="flex-1">
                  <span className="text-xl sm:text-2xl font-CormorantInfantBold block">{item.event}</span>
                  {item.note && (
        ...
        <div className="w-full px-4 sm:px-6 py-6 bg-white">
          <h3 className="text-3xl sm:text-4xl font-CormorantInfantBold text-center mb-6 max-w-2xl mx-auto">
            Где нас найти?
          </h3>
